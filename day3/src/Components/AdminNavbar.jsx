    ...
    <nav className="admin-navbar">
      <div className="admin-nav-left">
        ...
        <div className={`admin-nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <li><Link to="/admin/orders" onClick={() => setMenuOpen(false)}>Manage Orders</Link></li> {/* Link to AdminOrders */}
          <li><Link to="/admin/users" onClick={() => setMenuOpen(false)}>Manage Users</Link></li> {/* Link to AdminUsers */}
        </div>
      </div>
